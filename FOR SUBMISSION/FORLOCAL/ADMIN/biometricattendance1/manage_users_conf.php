                ...
                if (!$row = mysqli_fetch_assoc($resultl)) {
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                      ...
                      exit();
                        ...
                        $resultl = mysqli_stmt_get_result($result);
                        if (!$row = mysqli_fetch_assoc($resultl)) {
                            $sql = "INSERT INTO fingerprint (fingerprint_id, emp_id, last_name, user_name, add_fingerid) VALUES (?, ?, ?, ?, 1)";
                            $result = mysqli_stmt_init($conn1);
                            ...
                            if (!mysqli_stmt_prepare($result, $sql)) {
                              ...
                              exit();
                                ...
                                mysqli_stmt_bind_param($result, "iiss", $fingerid, $emp_id, $last_name, $user_name);
                                mysqli_stmt_execute($result);
