...
<div class="row mt-3 mb-1 d-flex justify-content-end  " >
  <div class="col-12">
    <div class="buttons " style="margin-top:10px;">
      <a href="../ADMIN/printAttendancerecords.php?printAll" class="inline-block bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md border border-green-500 hover:border-green-600 transition duration-300 ease-in-out" target="_blank"><i class="fas fa-print mr-2"></i> Print All Attendance Records</a>  
