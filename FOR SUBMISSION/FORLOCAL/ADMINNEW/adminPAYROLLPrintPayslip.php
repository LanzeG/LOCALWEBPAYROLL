...
<div class="row row2 mt-2">
  ...
  <?php
    $query5 ="SELECT * FROM payperiods ORDER BY pperiod_start ASC";
...
<div class=" d-flex align-items-center justify-content-center">
  <div class="  form-actions mt-3" >
    ...
    <a href="../ADMIN/NEWPAYSLIP.php?print_all" class="inline-block bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md border border-blue-500 hover:border-blue-600 transition duration-300 ease-in-out" target="_blank"><i class="fas fa-print mr-2"></i> Print All</a>
     <a href="../ADMIN/payslipcsv.php?print_all" class="inline-block bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-md border border-blue-500 hover:border-blue-600 transition duration-300 ease-in-out" target="_blank"><i class="fas fa-print mr-2"></i> Download CSV</a>              
  </div>
</form>
</div>
<!-- end form -->
