      ...
      <thead class="table-striped" style="background-color: #2ff29e; color: #4929aa;">
        <tr>
          ...
          <th>Employment Type</th>
            <?php if (!$master) { ?>
                <th style="border-top-right-radius: 10px; color: #4929aa;">Base Pay</th>
            <?php } else { ?>
                <th>Base pay</th>
...
?>
  ...
  <center>
    ...
    ?>
        ...
        <td>
            <center>
               <a href="editpayperperiod.php?id=<?php echo $row1['emp_id']; ?>&pperiod_range=<?php echo urlencode($row1['pperiod_range']); ?>" class="btn btn-primary">View</a>
            </center>
        </td>
